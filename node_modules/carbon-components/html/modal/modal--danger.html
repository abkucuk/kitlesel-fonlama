...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-s4wuwmxe1vr">Show
  modal</button>

<div data-modal id="modal-s4wuwmxe1vr" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-s4wuwmxe1vr-label" aria-describedby="modal-s4wuwmxe1vr-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-s4wuwmxe1vr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-s4wuwmxe1vr-heading">Modal heading</p>
