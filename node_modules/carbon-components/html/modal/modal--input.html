...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1o6mpk4cg6v">Show
  modal</button>

<div data-modal id="modal-1o6mpk4cg6v" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1o6mpk4cg6v-label" aria-describedby="modal-1o6mpk4cg6v-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1o6mpk4cg6v-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1o6mpk4cg6v-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-1o6mpk4cg6v" class="bx--label">Text Input label</label>
        <input id="text-input-1o6mpk4cg6v" type="text" class="bx--text-input" placeholder="Optional placeholder text"
