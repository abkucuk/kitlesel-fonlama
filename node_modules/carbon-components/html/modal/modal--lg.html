...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-flk0vga6x99">Show
  modal</button>

<div data-modal id="modal-flk0vga6x99" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-flk0vga6x99-label" aria-describedby="modal-flk0vga6x99-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-flk0vga6x99-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-flk0vga6x99-heading">Modal heading</p>
