...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-81he0f8g55m">Show
  modal</button>

<div data-modal id="modal-81he0f8g55m" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-81he0f8g55m-label" aria-describedby="modal-81he0f8g55m-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-81he0f8g55m-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-81he0f8g55m-heading">Modal heading</p>
