...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-13wu4x3m7y8">Show
  modal</button>

<div data-modal id="modal-13wu4x3m7y8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-13wu4x3m7y8-label" aria-describedby="modal-13wu4x3m7y8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-13wu4x3m7y8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-13wu4x3m7y8-heading">Modal heading</p>
