...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ez2goqg3h7">Show
  modal</button>

<div data-modal id="modal-ez2goqg3h7" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ez2goqg3h7-label" aria-describedby="modal-ez2goqg3h7-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ez2goqg3h7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ez2goqg3h7-heading">Modal heading</p>
