...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-la3p2j04u7">Show
  modal</button>

<div data-modal id="modal-la3p2j04u7" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-la3p2j04u7-label" aria-describedby="modal-la3p2j04u7-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-la3p2j04u7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-la3p2j04u7-heading">Modal heading</p>
