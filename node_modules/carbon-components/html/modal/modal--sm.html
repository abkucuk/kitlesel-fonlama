...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-udbov51t15">Show
  modal</button>

<div data-modal id="modal-udbov51t15" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-udbov51t15-label" aria-describedby="modal-udbov51t15-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-udbov51t15-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-udbov51t15-heading">Modal heading</p>
