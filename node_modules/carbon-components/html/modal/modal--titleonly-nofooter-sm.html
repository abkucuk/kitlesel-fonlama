...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-f9mrv4cj3r">Show
  modal</button>

<div data-modal id="modal-f9mrv4cj3r" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-f9mrv4cj3r-label" aria-describedby="modal-f9mrv4cj3r-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-f9mrv4cj3r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-f9mrv4cj3r-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
