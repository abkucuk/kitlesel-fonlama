...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mbe33aaugf">Show
  modal</button>

<div data-modal id="modal-mbe33aaugf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mbe33aaugf-label" aria-describedby="modal-mbe33aaugf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mbe33aaugf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mbe33aaugf-heading">Modal heading</p>
