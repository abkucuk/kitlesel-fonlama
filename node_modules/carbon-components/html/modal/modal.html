...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tkv95a7ag28">Show
  modal</button>

<div data-modal id="modal-tkv95a7ag28" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tkv95a7ag28-label" aria-describedby="modal-tkv95a7ag28-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tkv95a7ag28-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tkv95a7ag28-heading">Modal heading</p>
